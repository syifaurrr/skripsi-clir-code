...
# Pastikan path ini sesuai dengan struktur direktori Kaggle/Lokal Anda
...
# C. Pecah menjadi beberapa file dengan isi maksimal 15 baris (DIPERKECIL DARI 40)
# Ini untuk mencegah konteks Gemini terpotong karena harus generate 10 kueri per baris
chunk_size = 15
...
print("\n🎉 SELESAI! Silakan download file gemini_input_batch_*.csv dan unggah satu per satu ke Gemini Gems Anda.")
